    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        ...
        <FormLink
          ...
          className="flex-1 min-w-[160px] rounded-full border border-[var(--purple-light)] px-5 py-3 text-center text-sm font-semibold text-[var(--purple-light)] transition hover:border-[var(--gold)] hover:text-[var(--gold)]"
        >
          📝 Registration Form
        </FormLink>
      </div>
