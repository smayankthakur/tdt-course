      ...
      >
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <FormLink
            ...
            className="flex-1 min-w-[140px] rounded-full border border-[var(--purple-light)] px-4 py-2.5 text-center text-sm font-semibold text-[var(--purple-light)] transition hover:border-[var(--gold)] hover:text-[var(--gold)]"
          >
            📝 Registration Form
          </FormLink>
          <button
